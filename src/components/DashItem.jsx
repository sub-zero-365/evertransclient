    ...
    return (
        ...
        md:w-full mx-auto md:mx-initial overflow-hidden rounded-sm shadow-sm md:rounded-lg lg:rounded-xl bg-white dark:bg-slate-300">
            ...
            <div className="flex justify-between mb-4">
                ...
                <span className="h-8 w-8 md:w-10 md:h-10 hover:bg-slate-300 transition-colors duration-700 rounded-full z-10 grid place-items-center shadow-sm " onClick={()=>navigate(href || "/")}><AiOutlineSetting className="text-xl" /> </span>
            </div>
