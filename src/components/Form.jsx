      ...
      <div className="flex relative min-h-[40px]">
        <div className="relative w-full flex items-stretch">
          ...
          <button
            ...
            type="button" className="flex-none flex items-center justify-center min-w-[4rem] top-0 right-0 p-2.5 text-sm font-medium text-white bg-rose-700 rounded-r-lg
