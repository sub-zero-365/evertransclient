  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <h1 class="mb-4 text-2xl md:text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">Under Maintenance</h1>
      ...
      <img src="https://thumbs.gfycat.com/DearestUnkemptBeauceron-max-1mb.gif" className='max-w-sm mx-auto object-fit' alt="maintaince" />
    </section>
  )
}
